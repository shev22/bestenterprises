    ...
    <div class="container">
      <div class="row gy-4 d-flex justify-content-between">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h2 data-aos="fade-up">Real-Time &nbsp;<span id="app"></span></h2>
          <p data-aos="fade-up" data-aos-delay="100">A prominent digital marketing agency committed to enhancing your brand through comprehensive web3/Ai marketing marketing solutions across multiple channels, as well as offering expertise in branding and creative design. </p>
